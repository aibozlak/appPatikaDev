...
from customer right join payment on payment.customer_id = customer.customer_id;
...
/*
----> MySQL FULL JOIN keywordunu desteklemiyor.. Bunu LEFT JOIN ile RIGHT JOIN'i UNION ile birleştirerek çözmüşler..
----> Ancak o kunu daha işlenmedi. PosgreSQL'de şu komutu verirdim:
